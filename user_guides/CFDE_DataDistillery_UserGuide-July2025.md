...
#### Additional IDG Use Cases from examples 2 and 3 the [IDG User Guide](https://github.com/unmtransinfo/cfde-distillery/blob/main/doc/UserGuide/IDG_UBKG_queries_for_tutorial.md): 

Example 2: IDG use-case which combines our IDG dataset with both LINCS and GTEx
